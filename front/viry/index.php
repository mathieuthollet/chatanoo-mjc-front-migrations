...
<head>
	...
	<link rel='stylesheet' href='styles/mjc_viry.css' type='text/css' />
...
<body>
	...
	<div class="global">
        ...
        <div class="header">
            ...
            <div class="titre couleur_base"><p>MJC de Viry</p></div>
                        ...
                        <div class="accueil">
                            ...
                            <div class="projets borderTopRounded shadow">
                                ...
                                <div class="introduction">
                                    <span class="couleur_base">Bienvenue au site de débat de la MJC de Viry !</span>
	...
	<script src="js/setup_viry.js"></script>
