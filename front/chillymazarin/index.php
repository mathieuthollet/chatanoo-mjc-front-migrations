...
<head>
	<meta charset='UTF-8'>
	<title>MJC de Chilly-Mazarin</title>
	...
	<link rel='stylesheet' href='styles/mjc_chillymazarin.css' type='text/css' />
...
<body>
	...
	<div class="global">
        ...
        <div class="header">
            ...
            <div class="titre couleur_base"><p>MJC de Chilly-Mazarin</p></div>
                        ...
                        <div class="accueil">
                            ...
                            <div class="projets borderTopRounded shadow">
                                ...
                                <div class="introduction">
                                    <span class="couleur_base">Bienvenue au site de débat de la MJC de Chilly-Mazarin !</span>
	...
	<script src="js/setup_chillymazarin.js"></script>
