...
<head>
	...
	<link rel='stylesheet' href='styles/mjc_bonneuil.css' type='text/css' />
...
<body>
	...
	<div class="global">
        ...
        <div class="header">
            ...
            <div class="titre couleur_base"><p>MJC de Bonneuil</p></div>
                        ...
                        <div class="accueil">
                            ...
                            <div class="projets borderTopRounded shadow">
                                ...
                                <div class="introduction">
                                    <span class="couleur_base">Bienvenue au site de débat de la MJC de Bonneuil !</span>
	...
	<script src="js/setup_bonneuil.js"></script>
